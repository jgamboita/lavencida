#------------ maestra medicamentos ----------------
ALTER TABLE maestros.medicamento DROP COLUMN norma_vmr;
ALTER TABLE maestros.medicamento DROP COLUMN vmr;
ALTER TABLE maestros.medicamento DROP COLUMN valor_presentacion_comercial;
ALTER TABLE maestros.medicamento DROP COLUMN valor_unidad;

#------------ maestra medicamentos activos (foranea del archivo) -------
ALTER TABLE maestros.medicamento_activo DROP COLUMN norma_vmr;
ALTER TABLE maestros.medicamento_activo DROP COLUMN vmr;
ALTER TABLE maestros.medicamento_activo DROP COLUMN valor_presentacion_comercial;
ALTER TABLE maestros.medicamento_activo DROP COLUMN valor_unidad;
