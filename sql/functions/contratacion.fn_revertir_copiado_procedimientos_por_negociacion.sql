CREATE OR REPLACE FUNCTION contratacion.fn_revertir_copiado_procedimientos_por_negociacion(_negociacion_actual_id bigint, _negociacion_anterior_id bigint)
...
BEGIN
    ...
    WHERE sn.negociacion_id = _negociacion_actual_id
      AND sns.sede_negociacion_id = sn.id;
