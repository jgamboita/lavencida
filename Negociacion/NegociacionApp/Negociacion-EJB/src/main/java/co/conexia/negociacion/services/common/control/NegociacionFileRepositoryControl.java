package co.conexia.negociacion.services.common.control;
 ...
 *
 */
public class NegociacionFileRepositoryControl {
	...
	public byte[] obteneArchivo(String nombreArchivo, String path) throws ConexiaBusinessException{
		try {
			configure(path);
			return respositoryAccessManager.retrieveFile(new StoredFile(
					nombreArchivo));
