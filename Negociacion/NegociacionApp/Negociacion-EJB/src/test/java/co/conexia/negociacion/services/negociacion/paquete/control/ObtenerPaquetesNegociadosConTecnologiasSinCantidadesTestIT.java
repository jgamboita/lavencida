...
class ObtenerPaquetesNegociadosConTecnologiasSinCantidadesTestIT {

    private static EntityManager em;
    private static ObtenerPaquetesNegociadosConTecnologiasSinCantidades obtenerPaquetesNegociadosConTecnologiasSinCantidades;
    ...
    public static void setUpAll() {
        ...
        obtenerPaquetesNegociadosConTecnologiasSinCantidades = new ObtenerPaquetesNegociadosConTecnologiasSinCantidades(em, new MyLogger(LoggerFactory.getLogger(ObtenerPaquetesNegociadosSinValores.class)));
    }
    ...
    void obtenerPaquetes() {
        ...
        List<ErroresTecnologiasDto> erroresTecnologiasDtos = obtenerPaquetesNegociadosConTecnologiasSinCantidades.obtenerPaquetes(negociacion);
