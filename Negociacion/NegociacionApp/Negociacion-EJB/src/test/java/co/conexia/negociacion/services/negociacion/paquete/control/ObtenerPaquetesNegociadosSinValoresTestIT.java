...
class ObtenerPaquetesNegociadosSinValoresTestIT {

    private static EntityManager em;
    private static ObtenerPaquetesNegociadosSinValores obtenerPaquetesNegociadosCriteria;
    ...
    public static void setUpAll() {
        ...
        obtenerPaquetesNegociadosCriteria = new ObtenerPaquetesNegociadosSinValores(em, new MyLogger(LoggerFactory.getLogger(ObtenerPaquetesNegociadosSinValores.class)));
    }
    ...
    void obtenerPaquetes() {
        ...
        List<ErroresTecnologiasDto> erroresTecnologiasDtos = obtenerPaquetesNegociadosCriteria.obtenerPaquetes(negociacion);
