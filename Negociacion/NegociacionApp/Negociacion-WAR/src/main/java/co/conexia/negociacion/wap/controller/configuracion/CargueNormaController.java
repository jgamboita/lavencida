package co.conexia.negociacion.wap.controller.configuracion;
...
@Named
@ViewScoped
@URLMapping(id = "cargueNorma", pattern = "/cargueNorma", viewId = "/configuracion/cargueNorma/cargueNorma.page")
public class CargueNormaController implements Serializable{
