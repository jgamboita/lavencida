package co.conexia.negociacion.wap.controller.error;
...
@Named
@ViewScoped
@URLMapping(id = "handlerErrorController", pattern = "/error", viewId = "/error/default-error.page")
public class HandlerErrorController implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = 7141842803003748019L;
